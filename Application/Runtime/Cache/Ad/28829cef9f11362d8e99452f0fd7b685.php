...
<div class="main-div">
    <form method="post" action="/Ad/AdPos/add" enctype="multipart/form-data" >
        
        <table cellspacing="1" cellpadding="3" width="100%">
                        <tr>
                <td class="label">广告位名称:</td>
                <td>
                                        <input type="text" name="pos_name" maxlength="60" />
                ...
                <td>
                                        <input type="text" name="pos_width" maxlength="60" />
                                                            <span class="require-field">*</span>
                                    </td>
            </tr>
                     <tr>
                ...
                <td>
                                        <input type="text" name="pos_height" maxlength="60" />
                                                            <span class="require-field">*</span>
                                    </td>
            </tr>
