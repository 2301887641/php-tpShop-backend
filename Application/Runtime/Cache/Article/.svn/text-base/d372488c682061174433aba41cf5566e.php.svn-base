...
<body>
<h1>
    <span class="action-span"><a href="/Article/Article/add">添加文章表 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 文章表 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Article/Article/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Article/Article/bdel" name="listForm">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['cat_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['addtime'];?>                </td>
                               
             
                <td align="center">
                <a href="/Article/Article/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Article/Article/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
