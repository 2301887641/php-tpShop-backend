...
<body>
<h1>
    <span class="action-span"><a href="/Article/ArticleCat/add">添加文章分类 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 文章分类 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Article/ArticleCat/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Article/ArticleCat/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['id'];?>                </td>
                                <td align="center">
                   <?php echo $v['cat_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['is_help'];?>                </td>
                               <td align="center">
                   <?php echo $v['article_count'];?>                </td>
             
                <td align="center">
                <a href="/Article/ArticleCat/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Article/ArticleCat/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
