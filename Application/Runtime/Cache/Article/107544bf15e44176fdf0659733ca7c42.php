...
<div class="main-div">
    <form method="post" action="/Article/ArticleCat/add" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <td>
                                        ...
                                        <input type="radio" checked='checked' value="是" name="is_help">是                                         <input type="radio"  value="否" name="is_help">否                        
                                                            <span class="require-field">*</span>
                                    </td>
            </tr>
