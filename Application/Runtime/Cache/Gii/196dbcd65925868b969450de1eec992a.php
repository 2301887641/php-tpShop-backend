...
<body>
<h1>
    <span class="action-span"><a href="/Gii/Buttons/add">添加按钮表 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 按钮表 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Gii/Buttons/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Gii/Buttons/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['id'];?>                </td>
                                <td align="center">
                   <?php echo $v['btn_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['btn_url'];?>                </td>
                                <td align="center">
                   <?php echo $v['open_new'];?>                </td>
                                <td align="center">
                   <?php echo $v['btn_pos'];?>                </td>
                               
             
                <td align="center">
                <a href="/Gii/Buttons/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Gii/Buttons/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
