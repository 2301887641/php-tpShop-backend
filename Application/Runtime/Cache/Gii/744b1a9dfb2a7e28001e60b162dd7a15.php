...
<div class="main-div">
    <form method="post" action="/Gii/ShopConfig/save/id/29" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            <input type="hidden" name="id" value="<?php echo $data['id']?>">            <tr>
                ...
                <td>
                                        ...
                                        <input type="radio" <?php if($data['config_type']=='单行文本') echo "checked='checked'";?> value="单行文本" name="config_type">单行文本                                         <input type="radio" <?php if($data['config_type']=='单选') echo "checked='checked'";?> value="单选" name="config_type">单选                                         <input type="radio" <?php if($data['config_type']=='多行文本') echo "checked='checked'";?> value="多行文本" name="config_type">多行文本                        
                                                            <span class="require-field">*</span>
                                    </td>
            </tr>
                       <tr>
...
<!--                     <tr>
                ...
                <td>
                                        <input type="text" name="config_value" maxlength="60" value="<?php echo $data['config_value']?>"/>
                                                        </td>
            </tr>-->
