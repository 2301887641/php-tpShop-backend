...
<body>
<h1>
    <span class="action-span"><a href="/Gii/Recommend/add">添加推荐位 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 推荐位 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Gii/Recommend/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Gii/Recommend/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['id'];?>                </td>
                                <td align="center">
                   <?php echo $v['rec_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['rec_type'];?>                </td>
                               
             
                <td align="center">
                <a href="/Gii/Recommend/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Gii/Recommend/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
