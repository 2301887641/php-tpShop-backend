...
<div class="main-div">
    <form method="post" action="/Goods/Category/save/id/67" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="id" value="<?php echo $data['id']?>">  
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php foreach($category as $c): if($c['cat_name']==$data['cat_name']) continue; if($data['parent_id']==$c['id']) $check="selected='selected'"; else $check=""; ?>
