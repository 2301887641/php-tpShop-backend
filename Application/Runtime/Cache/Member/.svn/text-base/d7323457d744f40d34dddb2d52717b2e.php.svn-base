...
<head>
<title>ECSHOP 管理中心 - 会员级别表列表 </title>
...
<body>
<h1>
    <span class="action-span"><a href="/Member/MemberLevel/add">添加会员级别表 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 会员级别表 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Member/MemberLevel/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Member/MemberLevel/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['id'];?>                </td>
                                <td align="center">
                   <?php echo $v['level_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['num_bottom'];?>                </td>
                                <td align="center">
                   <?php echo $v['num_top'];?>                </td>
                                <td align="center">
                   <?php echo $v['rate'];?>                </td>
                               
             
                <td align="center">
                <a href="/Member/MemberLevel/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Member/MemberLevel/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
