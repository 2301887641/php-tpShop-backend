...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php  foreach($pri_name as $p):?>
            <li class="explode" key="02_cat_and_goods" name="menu">
            <?php echo $p['pri_name'];?>
                <ul>
                  <?php if(!empty($p['sub'])):?>
                  <?php foreach($p['sub'] as $pp):?>
                  <li class="menu-item"><a href="<?php echo U($pp['module_name'].'/'.$pp['controller_name'].'/'.$pp['action_name'])?>" target="main-frame"><?php echo $pp['pri_name']?></a></li>
                  <?php endforeach;?>
                  <?php endif;?>
                </ul>
            </li>
