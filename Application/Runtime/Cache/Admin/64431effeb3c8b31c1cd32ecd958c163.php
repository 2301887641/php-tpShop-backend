...
<body>
<h1>
    <span class="action-span"><a href="/Admin/Role/add">添加角色表 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 角色表 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Admin/Role/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Admin/Role/bdel" name="listForm">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['role_name'];?>                </td>
                                <td align="center">
                   <?php if($v['pri_id_list']=='*'): echo "全部权限"; else: echo $v['pri_name'];endif;?>                </td>
                               
             
                <td align="center">
                <a href="/Admin/Role/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                <?php if($v[id]!=1):?>
                | <a href="/Admin/Role/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
                <?php endif;?>
                </td>
            </tr>
