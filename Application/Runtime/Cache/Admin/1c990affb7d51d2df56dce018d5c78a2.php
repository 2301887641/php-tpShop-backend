...
<body>
<h1>
    <span class="action-span"><a href="/Admin/Privilege/add">添加权限表 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 权限表 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Admin/Privilege/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Admin/Privilege/bdel" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                <td class="first-cell" align="center">
                   ...
                   <?php echo $v['id'];?>                </td>
                                <td align="center">
                   <?php echo str_repeat('--',$v['level']*3).$v['pri_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['module_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['controller_name'];?>                </td>
                                <td align="center">
                   <?php echo $v['action_name'];?>                </td>
             
                               
             
                <td align="center">
                <a href="/Admin/Privilege/save/id/<?php echo $v['id']?>" title="编辑">编辑</a>
                | <a href="/Admin/Privilege/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
