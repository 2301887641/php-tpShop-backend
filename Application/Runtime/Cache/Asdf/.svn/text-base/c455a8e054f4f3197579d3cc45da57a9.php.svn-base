...
<body>
<h1>
    <span class="action-span"><a href="/Asdf/Goods/add">添加商品 </a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 商品 列表 </span>
    <div style="clear:both"></div>
</h1>
<div class="form-div">
    <form action="/Asdf/Goods/lst.html" method="get" name="searchForm">
...
<form method="post" action="/Asdf/Goods/bdel" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $v):?>            <tr>
                ...
                | <a href="/Asdf/Goods/del/id/<?php echo $v['id']?>" onclick="return confirm('是否要删除?')" title="编辑">移除</a> 
